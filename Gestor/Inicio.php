        ...
        <div id="Principal">
            ...
            <div style="text-align:right;font-size:14px;padding:3px;background-color:#fff;color:#333;">
                ...
                <div style=" 
                    ...
                    <h1 style="margin-top:20px;width:500px;border:solid 1px #FF6633;border-radius:15px 0px 15px 0px;margin-left:auto;margin-right:auto;padding:8px;box-shadow:0px 0px 5px #999999;"><img src="../Imagenes/Logo.png" ><br />Bienvenido</h1>
