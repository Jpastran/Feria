...
<table style="max-width:990px;margin:auto;width:100%;margin-top:20px;margin-bottom:150px" cellpadding="6">
  ...
  <tr>
    ...
    <td align="left"><input name="Correo" type="text" class="box" id="Correo" style="width:180px;" onkeydown="testForEnter();" value="<?php echo $_SESSION['Correo'];?>" readonly="readonly"/></td>
  ...
  <tr>
    ...
    <td align="left"><input type="button" name="btnEnviar" id="btnEnviar" class="button" value="Actualizar Datos" /></td>
  </tr>
  <tr>
